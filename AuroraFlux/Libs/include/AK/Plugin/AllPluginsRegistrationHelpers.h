...
namespace AK
{
	namespace SoundEngine
	{
		...
		{
			AKRESULT eFinal = AK_Success;
#if ( defined( AK_WIN ) && (!defined( AK_USE_METRO_API ) || _MSC_VER >= 1900)) || defined( AK_XBOX360 ) || defined( AK_PS3 ) || defined( AK_XBOXONE ) || defined( AK_PS4 )
			AK_CHECK_ERROR( AK::SoundEngine::RegisterPlugin( 
				AkPluginTypeEffect, 
				AKCOMPANYID_IZOTOPE, 
...
#endif
#if ( defined( AK_WIN ) && (!defined( AK_USE_METRO_API ) || _MSC_VER >= 1900) ) || defined( AK_XBOX360 ) || defined( AK_XBOXONE ) || defined( AK_PS4 )
...
#if ( defined( AK_WIN ) && (!defined( AK_USE_METRO_API ) || _MSC_VER >= 1900) ) || defined( AK_PS4 ) || defined( AK_XBOXONE ) || defined( AK_XBOX360 )
